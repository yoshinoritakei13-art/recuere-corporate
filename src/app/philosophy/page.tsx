    ...
    <>
      ...
      <div className="relative">
        ...
        <section className="relative min-h-[80vh] flex items-center pt-20 pb-32 px-8 overflow-hidden">
          ...
          {/* 装飾サークル */}
          <div className="absolute right-[10%] top-[20%] w-[300px] h-[300px] rounded-full border border-navy/10 opacity-50 max-md:hidden" />
          <div className="absolute right-[15%] top-[25%] w-[200px] h-[200px] rounded-full border border-navy/10 opacity-40 max-md:hidden" />
          ...
          <div className="relative z-10 max-w-7xl mx-auto w-full">
            <div className="md:ml-[10%]">
              <FadeIn>
                <p className="tracking-wide-4xl text-label-xs text-navy mb-6 uppercase font-medium">Philosophy</p>
              </FadeIn>
              ...
              <FadeIn delay={0.2}>
                <p className="text-text-faint text-label-md font-light mb-8">
                  From awareness to abundance
                </p>
              </FadeIn>

              <FadeIn delay={0.3}>
                <p className="text-text-muted leading-[2] max-w-md font-light">
                  一人ひとりが本来の自分に気づき、<br />
        ...
        <section className="md:sticky md:top-0 z-10 bg-white py-[60px] md:py-[100px] md:pb-[350px] px-6 md:px-8 shadow-section-top-light">
          <div className="max-w-[1100px] mx-auto">
            <FadeIn>
              <p className="tracking-wide-4xl text-label-xs text-navy mb-6 uppercase font-medium">Mission / Vision / Value</p>
            </FadeIn>
            <FadeIn delay={0.1}>
              <h2 className="text-[clamp(1.8rem,4vw,2.5rem)] tracking-[-0.02em] font-extralight text-text mb-8 md:mb-12">
                私たちが大切にしていること
              </h2>
            </FadeIn>
        ...
        <section className="md:sticky md:top-0 pt-[80px] md:pt-[140px] pb-[60px] md:pb-[450px] px-6 md:px-8 md:rounded-t-section-lg z-20 bg-white overflow-hidden shadow-section-top-medium">
          ...
          {/* 装飾ライン */}
          <div className="absolute left-[10%] top-[30%] w-[1px] h-[150px] bg-gradient-to-b from-transparent via-navy/20 to-transparent" />

          <div className="relative z-10 max-w-[800px] mx-auto">
            <FadeIn>
              <p className="tracking-wide-4xl text-label-xs text-navy mb-8 uppercase font-medium">Brand Story</p>
            </FadeIn>

            {/* 大きなタイトル */}
            <FadeIn delay={0.2}>
              <h3 className="text-[clamp(2rem,5vw,3.5rem)] tracking-[-0.02em] font-extralight text-text mb-6 leading-[1.3]">
            ...
            <FadeIn delay={0.3}>
              <div className="hidden md:flex items-center gap-4 mb-10 flex-wrap">
                <span className="text-[1.4rem] font-light text-navy">cue</span>
                <span className="text-[0.75rem] text-text-faint">気づきのきっかけ</span>
                <span className="text-[1.3rem] text-[#ccc]">+</span>
                <span className="text-[1.4rem] font-light text-navy">re</span>
                <span className="text-[0.75rem] text-text-faint">再び・繰り返し</span>
                <span className="text-[1.3rem] text-[#ccc]">=</span>
                <span className="text-[1.8rem] font-extralight text-text tracking-wide">recuere</span>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <div className="md:hidden mb-10 space-y-4 text-center">
                <div className="flex items-center justify-center gap-3">
                  <span className="text-[1.3rem] font-light text-navy">cue</span>
                  <span className="text-[0.8rem] text-text-faint">＝ 気づきのきっかけ</span>
                </div>
                <div className="flex items-center justify-center gap-3">
                  <span className="text-[1.3rem] font-light text-navy">re</span>
                  <span className="text-[0.8rem] text-text-faint">＝ 再び・繰り返し</span>
                </div>
                <div className="flex items-center justify-center gap-3 pt-4">
                  <span className="text-[1.3rem] font-light text-navy">cue + re</span>
                  <span className="text-[0.8rem] text-text-faint">＝</span>
                  <span className="text-[1.8rem] font-light text-navy font-['Sweet_Apricot',cursive]">recuere</span>
                </div>
              </div>
            </FadeIn>

            <FadeIn delay={0.4}>
              <p className="text-body-md md:text-body-lg leading-[2.2] text-text-light max-w-[650px] font-light">
                <strong className="font-medium">recuere®（リキュウレ®）</strong>は、心理学用語 cue（無意識に反応を引き起こす「気づきのきっかけ」）と、re（再び・繰り返し）を組み合わせた言葉です。
              </p>
            </FadeIn>

            <FadeIn delay={0.5}>
              <p className="text-body-sm md:text-body-md leading-[2.2] text-[#777] mt-8 max-w-[650px] font-light">
                人は、一度の気づきだけで変われるほど単純ではありません。だからこそ、立ち止まり、気づき直す瞬間が、人生や仕事の中で何度も必要だと、私たちは考えています。
              </p>
            </FadeIn>

            <FadeIn delay={0.6}>
              <p className="text-body-sm md:text-body-md leading-[2.2] text-[#777] mt-6 max-w-[650px] font-light">
                recuere®は、その節目ごとに、何度でも「気づきのきっかけ（cue）」を差し出し、自分らしい選択へとつながる時間を支える存在でありたい。
              </p>
            </FadeIn>

            <FadeIn delay={0.7}>
              <p className="text-body-sm md:text-body-md leading-[2.2] text-text-muted mt-6 max-w-[650px] font-light">
